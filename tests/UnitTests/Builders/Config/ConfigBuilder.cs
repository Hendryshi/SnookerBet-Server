...
namespace UnitTests.Builders
{
	public class ConfigBuilder
	{
		...
		public ConfigBuilder()
		{
			...
			_mockConfSection.SetupGet(m => m[It.Is<string>(s => s == "SnookerBetDB")]).Returns("Data Source=Hendryshi\\YSISQLSERVER;Initial Catalog=SnookerBet;Persist Security Info=True;User ID=sa;Password=pwd");
